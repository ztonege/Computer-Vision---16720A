...
parser.add_argument('--threshold', type=float, default=1.5e-2, help='dp threshold of Lucas-Kanade for terminating optimization')
...
for i in range(1, seq.shape[2]):
    ...
    if i == 1 or i == 19 or i == 39 or i == 59 or i == 79:
        ...
        plt.show() 
np.save('../result/girlseqrects-wcrt', rect_arr)
